server <- function(input, output, session) {
  ...
  observe({
    ...
    cKey <- "CFuzH2CxRRzvU80Uz5qeNE9j9"
    cSecret <- "T2YLcyGTwNBxdnLi2goKuciLMmFu19v3e9hq9Ptq8kKx6npWDf"
    accesstoken <- "148269860-6uZcCMW46Ic51sYF5siUeXFT7Ml1aG7dvlwRZI5P"
    accesssecret <- "hjzUldYKbhaQggwS5twqtDBHdoMp8XOIxo1Ikdw5gZwxO"
